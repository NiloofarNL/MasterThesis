...
```{r geography of communas, include = FALSE}

install.packages("remotes")
remotes::install_github("paezha/bSantiago", force = TRUE)
library(bSantiago)
...
# Get the path to the Excel file within the package's data directory
# file_pat<- system.file("data-raw", "SantiagoSurvey2016.xlsx", package = "bSantiago")
# SantiagoSurvey <- readxl::read_excel(file_pat)
...
```{r geography of communas for chapter 3}
...
file_path1 <- system.file("MSc-Thesis", "comunas_1", package = "Masterthesis")
comunas_1 <- st_read(paste0(here(), "/comunas_1/comunas_1Polygon.shp"))
```
